...
const FooterSection = () => {
  return (
    <div className="bg-neutral-900">
      <div className="h-80 flex md:flex-row flex-col-reverse md:justify-between md:items-center md:space-x-20 lg:space-x-30 justify-center max-w-5xl mx-auto px-6">
